...
//byHofeBY #define USE_IR_REMOTE                            // Send IR remote commands using library IRremoteESP8266 and ArduinoJson (+4k code, 0k3 mem, 48 iram)
//byHofeBY   #define USE_IR_RECEIVE                         // Support for IR receiver (+5k5 code, 264 iram)
